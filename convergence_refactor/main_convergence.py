...
from models.solver_dg_bdf    import SolverDgBDF      # swap to any of the 8 solver classes
from ModelParams    import DgParams          # matching ModelParams subclass
from TestConfigs    import COSINE_SPATIAL    # swap to any TestConfig instance
from utilities.enum_utilities import ConvType
...
from Runners import run_spatial_convergence, run_polynomial_convergence, run_temporal_convergence
