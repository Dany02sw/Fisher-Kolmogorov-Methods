...
from utilities.enum_utilities import PolyDegree, BdfOrder, ThetaMethod, MeshType, MeshStructure, BrainSection
...
class TestConfig:
    ...
    Attributes:
        ...
        t0            : initial time
        d_ext_conv    : diffusivity used in convergence tests
        d_ext_sim     : diffusivity used in forward simulations
