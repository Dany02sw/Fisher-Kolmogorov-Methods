...
from utilities.enum_utilities      import SpaceMethod, PenaltyType
from utilities.transform_utilities import Identity
from utilities.fenics_utilities    import havg
