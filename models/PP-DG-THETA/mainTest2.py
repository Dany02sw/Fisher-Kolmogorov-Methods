from models.solver_ppdg_theta import SolverPpDgTheta
...
from utilities.enum_utilities      import ConvType, MeshType, MeshStructure
from plots.plot_utilities          import plot_spatial_convergence, plot_polynomial_convergence, plot_time_convergence
from utilities.print_utilities     import print_space_rates, print_polynomial_rates, print_time_rates, print_title, print_subtitle
from utilities.math_utilities      import get_decimals
    ...
    if convType == ConvType.SPATIAL:
        ...
        with timer(f"Space convergence l={l_space}"):
            for N in N_list:
                ...
                Solver  = SolverPpDgTheta(mesh=mesh, D=D, alpha=alpha, c_0=c_ex, eps=eps, eta_0=eta_0, smoothing=smoothing)
        ...
        print_time_rates(errors_time_L2, errors_time_DG, dt_list, tht_time, time_method=Solver.TM, space_method=Solver.SM)

        # Plot the rates
        plot_time_convergence(dt_list, errors_time_L2, errors_time_DG, tht_time, method=Solver.TM, space_method=Solver.SM, save=False)
