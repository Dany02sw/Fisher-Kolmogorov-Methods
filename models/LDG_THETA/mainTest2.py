from models.solver_ldg_theta import SolverLdgTheta
...
if __name__ == "__main__":
    ...
    if convType == ConvType.SPATIAL:
        ...
        print_time_rates(errors_time_c, errors_time_q, dt_list, tht_time, time_method=Solver.TM, space_method=Solver.SM)
